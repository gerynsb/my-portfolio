      ...
      <div className="p-6">
        ...
        <div className="flex gap-3 pt-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white hover:bg-blue-700 transition-colors text-sm font-medium px-4 py-2 rounded-lg"
          >
          ...
          {project.githubUrl && (
            <a
              ...
              className="flex items-center justify-center gap-2 bg-gray-800 text-white hover:bg-gray-900 transition-colors text-sm font-medium px-4 py-2 rounded-lg"
            >
